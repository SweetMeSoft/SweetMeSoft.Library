...
`HughesNet.Tools` is a library for .NET Standard 2.1 that groups a collection of static helper classes to perform a variety of tasks, from type conversions and validations to email sending and data encryption.
...
```bash
dotnet add package HughesNet.Tools
```

## Usage Example

```csharp
using HughesNet.Tools;
