...
public class StreamFile
{
    ...
    public StreamFile(string fileName, Stream stream, string contentType)
    {
        FileName = fileName;
        Stream = stream;
        ContentType = Constants.ContentTypesDict.FirstOrDefault(model => model.Value == contentType).Key; ;
        Created = DateTime.Now;
    }
